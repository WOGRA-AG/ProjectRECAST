...
--
-- Name: element_properties; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE "public"."element_properties" OWNER TO "postgres";

--
-- Name: ElementProperties_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: step_properties; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE "public"."step_properties" OWNER TO "postgres";

--
-- Name: StepProperty_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
CREATE TABLE "public"."devices" (
    "id" bigint NOT NULL,
    "device_id" "uuid" DEFAULT "extensions"."uuid_generate_v4"(),
    "user_id" "uuid"
);
...
--
-- Name: tf_test_table_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE "public"."upload" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."tf_test_table_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: element_properties ElementProperties_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: processes Process_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: step_properties StepProperty_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: steps Step_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: upload tf_test_table_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."upload"
    ADD CONSTRAINT "tf_test_table_pkey" PRIMARY KEY ("id");


--
-- Name: elements unique_name_processid; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."elements"
    ADD CONSTRAINT "unique_name_processid" UNIQUE ("process_id", "name");


--
-- Name: element_properties unique_stepprop_element; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: processes Processes_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: element_properties element_properties_element_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."element_properties"
    ADD CONSTRAINT "element_properties_element_id_fkey" FOREIGN KEY ("element_id") REFERENCES "public"."elements"("id") ON DELETE CASCADE;


--
-- Name: element_properties element_properties_step_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."element_properties"
    ADD CONSTRAINT "element_properties_step_property_id_fkey" FOREIGN KEY ("step_property_id") REFERENCES "public"."step_properties"("id") ON DELETE CASCADE;


--
-- Name: elements fk_process; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: steps fk_process; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: step_properties fk_step; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: upload upload_bucket_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."upload"
    ADD CONSTRAINT "upload_bucket_fkey" FOREIGN KEY ("bucket") REFERENCES "storage"."buckets"("id");


--
-- Name: upload upload_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."upload"
    ADD CONSTRAINT "upload_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."devices"("device_id");


--
-- Name: upload upload_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."upload"
    ADD CONSTRAINT "upload_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: devices Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON "public"."devices" FOR SELECT USING (("auth"."uid"() = "user_id"));


--
-- Name: element_properties Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: elements Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: processes Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: step_properties Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: steps Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: upload Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON "public"."upload" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
--
-- Name: element_properties; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: step_properties; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: upload; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."upload" ENABLE ROW LEVEL SECURITY;

--
-- Name: profiles view only own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "element_properties"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "ElementProperties_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "Elements_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "step_properties"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "StepProperty_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "Step_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "upload"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "tf_test_table_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."tf_test_table_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."tf_test_table_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."tf_test_table_id_seq" TO "service_role";
